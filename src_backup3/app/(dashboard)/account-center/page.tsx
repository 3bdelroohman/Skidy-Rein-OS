  ...
  if (!canAccess) {
    return (
      <PageStateCard
        ...
        descriptionAr="Ù‡Ø°Ù‡ Ø§Ù„ØµÙØ­Ø© Ù…Ø®ØµØµØ© Ù„Ù„Ø¥Ø¯Ø§Ø±Ø© ÙˆÙØ±ÙŠÙ‚ Ø§Ù„Ø£ÙƒØ§ÙˆÙ†Øª."
    ...
    return (
      <div className="flex min-h-[50vh] items-center justify-center">
        <div className="flex items-center gap-3 rounded-2xl border border-border bg-card px-5 py-4 text-sm text-muted-foreground">
          ...
          {t(locale, "Ø¬Ø§Ø±ÙŠ ØªØ­Ù…ÙŠÙ„ Ù…Ø±ÙƒØ² Ø§Ù„Ø£ÙƒØ§ÙˆÙ†Øª...", "Loading Account Center...")}
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-7 text-muted-foreground">
            {t(
              locale,
              "Ù‚Ø§Ø¦Ù…Ø© Ø¹Ù…Ù„ ÙŠÙˆÙ…ÙŠØ© Ù„Ù…ØªØ§Ø¨Ø¹Ø© Ø§Ù„ØªØ­ØµÙŠÙ„ Ø§Ù„ÙŠØ¯ÙˆÙŠØŒ Ø§Ù„Ø­ØµØµ Ø§Ù„Ù…ØºØ·Ø§Ø©ØŒ Ø§Ù„ØªØ¬Ø¯ÙŠØ¯Ø§ØªØŒ Ø§Ù„Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø§Ù„Ø²Ø§Ø¦Ø¯ØŒ ÙˆØ§Ù„Ø·Ù„Ø§Ø¨ Ø§Ù„Ø°ÙŠÙ† Ø¯ÙØ¹ÙˆØ§ ÙˆÙŠØ­ØªØ§Ø¬ÙˆÙ† ØªØ³Ù„ÙŠÙ…Ù‹Ø§ Ù„Ù„Ø£ÙˆØ¨Ø±ÙŠØ´Ù†.",
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm leading-7 text-amber-900 dark:border-amber-900/60 dark:bg-amber-950/30 dark:text-amber-100">
          <div className="flex items-start gap-3">
            ...
            <p>
              {t(
                locale,
                "ÙŠÙˆØ¬Ø¯ " + urgentCount + " Ø·Ø§Ù„Ø¨ ÙŠØ­ØªØ§Ø¬ÙˆÙ† Ù…ØªØ§Ø¨Ø¹Ø© ØªØ¬Ø¯ÙŠØ¯ Ø£Ùˆ Ù…Ø±Ø§Ø¬Ø¹Ø© Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø§Ù„ØªØ­ØµÙŠÙ„.",
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
        <WorkQueue title={t(locale, "ÙŠØ­ØªØ§Ø¬ ØªØ¬Ø¯ÙŠØ¯", "Needs renewal")} description={t(locale, "Ø§Ù„ØªØ­ØµÙŠÙ„ Ø§Ù†ØªÙ‡Øª Ø£Ùˆ Ù„Ø§ ÙŠÙˆØ¬Ø¯ Ù…ØªØ¨Ù‚ÙŠ Ù…Ù† Ø§Ù„Ø­ØµØµ.", "Collection is finished or has no remaining sessions.")} items={data.needsRenewal} emptyText={t(locale, "Ù„Ø§ ÙŠÙˆØ¬Ø¯ Ø·Ù„Ø§Ø¨ ÙŠØ­ØªØ§Ø¬ÙˆÙ† ØªØ¬Ø¯ÙŠØ¯ Ø§Ù„Ø¢Ù†.", "No students need renewal now.")} tone="danger" locale={locale} />
        <WorkQueue title={t(locale, "Ù‚Ø±Ø¨ Ø§Ù„ØªØ¬Ø¯ÙŠØ¯", "Near renewal")} description={t(locale, "Ù…ØªØ¨Ù‚ÙŠ Ø­ØµØªØ§Ù† Ø£Ùˆ Ø£Ù‚Ù„ Ù…Ù† Ø§Ù„Ø­ØµØµ Ø§Ù„Ù…ØºØ·Ø§Ø©.", "Two sessions or fewer remain from the covered sessions.")} items={data.nearRenewal} emptyText={t(locale, "Ù„Ø§ ÙŠÙˆØ¬Ø¯ Ø·Ù„Ø§Ø¨ Ù‚Ø±Ø¨ Ø§Ù„ØªØ¬Ø¯ÙŠØ¯ Ø­Ø§Ù„ÙŠÙ‹Ø§.", "No students are near renewal right now.")} tone="warning" locale={locale} />
        <WorkQueue title={t(locale, "Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø²Ø§Ø¦Ø¯", "Overused")} description={t(locale, "Ø§Ù„Ø·Ø§Ù„Ø¨ Ø­Ø¶Ø± Ø­ØµØµÙ‹Ø§ Ø£ÙƒØ«Ø± Ù…Ù† Ø§Ù„Ù…ØºØ·Ù‰ ÙÙŠ Ø¢Ø®Ø± Ø¯ÙØ¹Ø©.", "Student attended more sessions than the latest paid collection covers.")} items={data.overused} emptyText={t(locale, "Ù„Ø§ ÙŠÙˆØ¬Ø¯ Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø²Ø§Ø¦Ø¯.", "No overused collections.")} tone="danger" locale={locale} />
        <WorkQueue title={t(locale, "ÙŠØ­ØªØ§Ø¬ ØªØ³Ù„ÙŠÙ… Ù„Ù„Ø£ÙˆØ¨Ø±ÙŠØ´Ù†", "Pending operations handoff")} description={t(locale, "Ø·Ù„Ø§Ø¨ Ù„Ø¯ÙŠÙ‡Ù… Ø¯ÙØ¹Ø© ÙˆÙ„ÙƒÙ† Ù„Ø§ ÙŠØ¸Ù‡Ø± Ù„Ù‡Ù… Ø¬Ø±ÙˆØ¨ Ù†Ø´Ø· Ø¨Ø¹Ø¯.", "Students have a payment but no active group appears yet.")} items={data.pendingHandoff} emptyText={t(locale, "Ù„Ø§ ÙŠÙˆØ¬Ø¯ ØªØ³Ù„ÙŠÙ… Ù…Ø¹Ù„Ù‚ Ù„Ù„Ø£ÙˆØ¨Ø±ÙŠØ´Ù†.", "No pending operations handoff.")} tone="info" locale={locale} />
        <WorkQueue title={t(locale, "Ø¨Ù„Ø§ Ø¯ÙØ¹Ø©", "No payment")} description={t(locale, "Ø·Ù„Ø§Ø¨ Ù…ÙˆØ¬ÙˆØ¯ÙˆÙ† ÙÙŠ Ø§Ù„Ù†Ø¸Ø§Ù… Ù„ÙƒÙ† Ù„Ø§ ØªÙˆØ¬Ø¯ Ù„Ù‡Ù… Ø¯ÙØ¹Ø© Ù…Ø¯ÙÙˆØ¹Ø© Ø£Ùˆ Ø¬Ø²Ø¦ÙŠØ©.", "Students exist in the system but have no paid or partial payment.")} items={data.noPayment} emptyText={t(locale, "Ù„Ø§ ÙŠÙˆØ¬Ø¯ Ø·Ù„Ø§Ø¨ Ø¨Ù„Ø§ Ø¯ÙØ¹Ø©.", "No students without payment.")} tone="warning" locale={locale} />
        <WorkQueue title={t(locale, "Ø­Ø§Ù„Ø© Ø¬ÙŠØ¯Ø©", "Healthy")} description={t(locale, "Ø·Ù„Ø§Ø¨ Ù„Ø¯ÙŠÙ‡Ù… Ø¨Ø§Ù‚Ø© Ù†Ø´Ø·Ø© ÙˆÙ„Ø§ ÙŠØ­ØªØ§Ø¬ÙˆÙ† Ù…ØªØ§Ø¨Ø¹Ø© ØªØ¬Ø¯ÙŠØ¯ Ø§Ù„Ø¢Ù†.", "Students have an active collection and do not need renewal follow-up now.")} items={data.healthy.slice(0, 10)} emptyText={t(locale, "Ù„Ø§ ÙŠÙˆØ¬Ø¯ Ø·Ù„Ø§Ø¨ ÙÙŠ Ø§Ù„Ø­Ø§Ù„Ø© Ø§Ù„Ø¬ÙŠØ¯Ø© Ø­Ø§Ù„ÙŠÙ‹Ø§.", "No healthy collection records right now.")} tone="success" locale={locale} />
      </div>
    </div>
  );
}
...
function StudentQueueCard({ item, locale }: { item: AccountCenterStudentItem; locale: "ar" | "en" }) {
  const latestAmount = item.latestPayment ? formatCurrency(item.latestPayment.amount, locale) : "â€”";
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="min-w-0">
          ...
          <div className="mt-3 flex flex-wrap gap-2 text-[11px] text-muted-foreground">
            <span className="rounded-full bg-muted px-2.5 py-1">{t(locale, "Ù…Ø³ØªØ®Ø¯Ù…", "Used")}: {item.usedSessions}</span>
            <span className="rounded-full bg-muted px-2.5 py-1">{t(locale, "Ù…ØªØ¨Ù‚ÙŠ", "Remaining")}: {item.remainingSessions}</span>
            <span className="rounded-full bg-muted px-2.5 py-1">{t(locale, "Ø§Ù„Ù…ØºØ·Ù‰", "Covered")}: {item.sessionsCovered}</span>
            {item.overusedSessions > 0 ? <span className="rounded-full bg-danger-50 px-2.5 py-1 text-danger-700 dark:bg-danger-950/30 dark:text-danger-300">{t(locale, "Ø²ÙŠØ§Ø¯Ø©", "Overused")}: {item.overusedSessions}</span> : null}
          </div>
        </div>

        <div className="flex shrink-0 flex-col gap-2 text-xs text-muted-foreground md:items-end">
          <span>{t(locale, "Ø¢Ø®Ø± Ø¯ÙØ¹Ø©", "Latest payment")}: {latestAmount}</span>          <span>{latestDate ? formatDate(latestDate, locale) : "â€”"}</span>
          {nextCollectionDueDate ? <span>{t(locale, "Ù…ÙˆØ¹Ø¯ Ø§Ù„ØªØ­ØµÙŠÙ„", "Collection due")}: {formatDate(nextCollectionDueDate, locale)}</span> : null}
          {collectionStatus ? <span>{t(locale, "Ø­Ø§Ù„Ø© Ø§Ù„ØªØ­ØµÙŠÙ„", "Collection status")}: {collectionStatus}</span> : null}
          {collectionNotes ? <span className="max-w-[240px] text-right leading-5">{t(locale, "Ù…Ù„Ø§Ø­Ø¸Ø§Øª", "Notes")}: {collectionNotes}</span> : null}
          <div className="flex flex-wrap gap-2">
            ...
            {item.paymentHref ? (
              ...
              <Link href={"/payments/new?studentId=" + item.student.id} className="inline-flex items-center gap-1 rounded-xl bg-brand-600 px-3 py-1.5 font-semibold text-white hover:bg-brand-700">
                {t(locale, "Ø¥Ø¶Ø§ÙØ© Ø¯ÙØ¹Ø©", "Add payment")} <ArrowUpRight size={13} />
              </Link>
            )}
          </div>
        </div>
